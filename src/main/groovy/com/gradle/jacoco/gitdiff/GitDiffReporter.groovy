...
//def SRC_FILE_RE = re.compile('^diff --git "?a/.*"? "?b/([^ \n"]*)"?')
//def MERGE_CONFLICT_RE = re.compile('^diff --cc ([^ \n]*)')
//def	HUNK_LINE_RE = re.compile('\\+([0-9]*)')
//
//public GitDiffReporter(compare_branch='origin/master', git_diff=None, ignore_unstaged=None){
//	"""
...
//def _get_included_diff_results(){
//
